...
const inputVariables = cva("w-full p-2 py-1.5 placeholder:text-background/80 text-background disabled:opacity-50 rounded-full", {
  variants: {
    variant: {
      ...
      outline: "bg-transparent text-foreground placeholder:text-foreground/80 border border-foreground rounded-full focus:outline-none focus:ring-2 focus:ring-foreground/50",
